...
class CockpitMusicPlayer(Screen, HelpableScreen, CockpitSeek, CockpitCueSheet):
	...
	def __init__(self, session, song_list, song_index, service_center):
		logger.debug("song_index: %s, song_list: %s", song_index, str(song_list))
	...
	def setFolderCover(self):
		...
		cover_filenames = ["folder.png", "Folder.png", "folder.jpg", "Folder.jpg", "cover.jpg", "Cover.jpg", "cover.png", "Cover.png", "coverArt.jpg"]
